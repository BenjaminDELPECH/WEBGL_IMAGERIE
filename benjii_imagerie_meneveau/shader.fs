...
void initializePlans(inout Plan planTab[nbPlan]){
  ...
  vec3 color1 = vec3(0.2,0.7,0.2);
    ...
    planTab[0] = Plan(vec3(1.0,1.0,-1000.0),planD,material1, 0.0);
    planTab[1] = Plan(vec3(-1000.0,-220.0,1.0),planD,material2, 0.0);
    planTab[2] = Plan(vec3(planX,planY,planZ),planD,material3, 0.0);
